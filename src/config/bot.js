...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "Racing in FRIC", // required by Discord API, not shown in the client
        state: "Racing in FRIC",     // this is what people actually see
        type: 5,               // Custom
      },
    ],
  },
...
embeds: {
  ...
  welcome: {
    ...
    defaultWelcomeChannel: 1527029523508494479,
